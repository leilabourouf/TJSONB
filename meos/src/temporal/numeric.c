...
extern double float8_in(const char *num, const char *type_name,
...
static bool apply_typmod(NumericVar *var, int32 typmod, void *escontext); // MEOS
static bool apply_typmod_special(Numeric num, int32 typmod, void *escontext); // MEOS
...
Numeric
numeric_abs_internal(Numeric num)
{
  /*
...
Numeric
numeric_uplus_internal(Numeric num)
{
  return duplicate_numeric(num);
}

Numeric
numeric_uminus_internal(Numeric num)
{
  /*
   * Do it the easy way directly on the packed format
   */
 ...
 * MEOS: The static function was renamed to numeric_sign_int to enable the
 * function numeric_sign_internal in the API
 */
static int
numeric_sign_int(Numeric num)
{
  if (NUMERIC_IS_SPECIAL(num))
  {
 ...
 */
int32
width_bucket_numeric_internal(Numeric operand, Numeric bound1, Numeric bound2,
  int32 count)
{
...
int
numeric_cmp_internal(Numeric num1, Numeric num2)
{
  return cmp_numerics(num1, num2);
}

bool
numeric_eq_internal(Numeric num1, Numeric num2)
{
...
int
hash_numeric_internal(Numeric key)
{
  Datum    digit_hash;
  Datum    result;
  int      weight;
 ...
 */
uint64
hash_numeric_extended_internal(Numeric key, uint64 seed)
{
  Datum    digit_hash;
  Datum    result;
  int      weight;
 ...
 */
Numeric
numeric_add_internal(Numeric num1, Numeric num2)
{
 ...
 */
Numeric
numeric_sub_internal(Numeric num1, Numeric num2)
{
 ...
 */
Numeric
numeric_mul_internal(Numeric num1, Numeric num2)
{
 ...
 */
Numeric
numeric_div_internal(Numeric num1, Numeric num2)
{
 ...
 */
Numeric
numeric_div_trunc_internal(Numeric num1, Numeric num2)
{
  NumericVar  arg1;
  NumericVar  arg2;
  NumericVar  result;
 ...
 */
Numeric
numeric_mod_internal(Numeric num1, Numeric num2)
{
 ...
 */
Numeric
numeric_inc_internal(Numeric num)
{
  NumericVar  arg;
  Numeric    res;
 ...
 */
Numeric
numeric_smaller_internal(Numeric num1, Numeric num2)
{
  /*
 ...
 */
Numeric
numeric_larger_internal(Numeric num1, Numeric num2)
{
  /*
   * Use cmp_numerics so that this will agree with the comparison operators,
   * particularly as regards comparisons involving NaN.
 ...
 */
Numeric
numeric_gcd_internal(Numeric num1, Numeric num2)
{
  NumericVar  arg1;
  NumericVar  arg2;
  NumericVar  result;
 ...
 */
Numeric
numeric_lcm_internal(Numeric num1, Numeric num2)
{
  NumericVar  arg1;
  NumericVar  arg2;
  NumericVar  result;
 ...
 */
Numeric
numeric_sqrt_internal(Numeric num)
{
  Numeric    res;
  NumericVar  arg;
  NumericVar  result;
 ...
 */
Numeric
numeric_exp_internal(Numeric num)
{
  Numeric    res;
  NumericVar  arg;
  NumericVar  result;
 ...
 */
Numeric
numeric_ln_internal(Numeric num)
{
  Numeric    res;
  NumericVar  arg;
  NumericVar  result;
 ...
 */
Numeric
numeric_log_internal(Numeric num1, Numeric num2)
{
  ...
  if (NUMERIC_IS_SPECIAL(num1) || NUMERIC_IS_SPECIAL(num2))
  {
    ...
    sign1 = numeric_sign_int(num1);
    sign2 = numeric_sign_int(num2);
    if (sign1 < 0 || sign2 < 0)
      meos_error(ERROR, MEOS_ERR_INVALID_ARG_VALUE,
         "cannot take logarithm of a negative number");
 ...
 */
Numeric
numeric_power_internal(Numeric num1, Numeric num2)
{
  Numeric    res;
  NumericVar  arg1;
  NumericVar  arg2;
 ...
 */
int
numeric_scale_internal(Numeric num)
{
  if (NUMERIC_IS_SPECIAL(num))
    return INT_MAX;
 ...
 */
Numeric
numeric_trim_scale_internal(Numeric num)
{
  Numeric    res;
  NumericVar  result;
    ...
    else
    {
      if (NUMERIC_IS_NAN(num))
        meos_error(ERROR, MEOS_ERR_FEATURE_NOT_SUPPORTED,
             "cannot convert NaN to %s", "integer");
      else
        meos_error(ERROR, MEOS_ERR_FEATURE_NOT_SUPPORTED,
...
numeric_int2_internal(Numeric num)
{
  ...
  if (NUMERIC_IS_SPECIAL(num))
  {
    if (NUMERIC_IS_NAN(num))
      meos_error(ERROR, MEOS_ERR_FEATURE_NOT_SUPPORTED,
           "cannot convert NaN to %s", "smallint");
    else
      meos_error(ERROR, MEOS_ERR_FEATURE_NOT_SUPPORTED,
...
numeric_float8_internal(Numeric num)
{
  ...
  char *tmp = numeric_out_internal(num);
  double result = float8_in(tmp, "double precision", tmp);
...
// {
  ...
  // char *tmp = numeric_out(num));
  // float4 result = DatumGetFloat4(DirectFunctionCall1(float4in,
    // CStringGetDatum(tmp));
  // pfree(tmp);
  // return result;
// }
         ...
         void *escontext UNUSED)
{
  ...
  if (*cp == 'e' || *cp == 'E')
  {
     ...
     * for consistency use the same meos_error errcode/text as make_result().
     */
...
set_var_from_non_decimal_integer_str(const char *str, const char *cp, int sign,
                   int base, NumericVar *dest,
                   const char **endptr, void *escontext UNUSED)
{
 ...
 */
static bool
apply_typmod(NumericVar *var, int32 typmod, void *escontext UNUSED)
{
  int      precision;
  int      scale;
  int      maxdigits;
 ...
 */
static bool
apply_typmod_special(Numeric num, int32 typmod, void *escontext UNUSED)
{
